...
func TestWrite(t *testing.T) {
	...
	allRecords = append(allRecords, record.Record{Key: "b123", Value: []byte{1, 1, 1, 1, 1, 1, 1, 1}, Timestamp: 521, Tombstone: true})
	allRecords = append(allRecords, record.Record{Key: "c315", Value: []byte{5, 5, 5, 5, 5, 5, 5, 5}, Timestamp: 564116, Tombstone: true})
	...
	allRecords = append(allRecords, record.Record{Key: "f561", Value: []byte{1, 1, 1, 1, 1, 1, 1, 1}, Timestamp: 35116516, Tombstone: true})
