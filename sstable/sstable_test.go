...
func TestWrite(t *testing.T) {
	...
	allRecords = append(allRecords, record.Record{Key: "ekrem", Value: []byte{5, 5, 5, 5, 5, 5, 5, 5}, Timestamp: 46156165, Tombstone: true})
	...
	allRecords = append(allRecords, record.Record{Key: "ivana", Value: []byte{1, 1, 1, 1, 1, 1, 1, 1}, Timestamp: 566464, Tombstone: true})
	allRecords = append(allRecords, record.Record{Key: "jovan", Value: []byte{5, 5, 5, 5, 5, 5, 5, 5}, Timestamp: 35461, Tombstone: true})
